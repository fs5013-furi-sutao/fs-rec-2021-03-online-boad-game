...
<table>
    ...
    <tr>
        ...
        <td>―</td>
        <td>開場</td>
        <td>こちらから入場ください<br /><br />FSオンラインボードゲーム大会・REMO：<br />https://live.remo.co/e/fs-4</td>
    </tr>
    <tr>
        <td>14:00 ～</td>
        <td>5分</td>
...
## 🕢 各テーブルに別れてから
 ...
 <table>
    ...
    <tr>
        ...
        <td>10分</td>
        <td>①事前にアカウントの作成</td>
        <td>手順はこちらです<br />[ボードゲームアリーナでのアカウント作成手順](./how-to-get-starting-online-boad-game.md)</td>
    </tr>
    <tr>
        <td>15:00 ～</td>
        <td>10分</td>
